Capstone.Views.FavoritesIndex = Backbone.CompositeView.extend({
  ...
  render: function() {
    ...
    for (var i = 0; i < photos.length; i+=3) {
      ...
      if (photos[i+1]) {
        ...
        var img2 = $(document.createElement("img")).attr("src", photos[i+1].escape("image_url"))
      ...
      if (photos[i+2]) {
        ...
        var img3 = $(document.createElement("img")).attr("src", photos[i+2].escape("image_url"))
      ...
      this.$(".favorite-index-item").append(div);
    }
  ...
  aspectRatios: function(p1, p2, p3) {
    // debugger
    var r1 = (p1.escape("x_pixels")) / (p1.escape("y_pixels"));
    var r2 = (p2 == undefined) ? 1 : (p2.escape("x_pixels")) / (p2.escape("y_pixels"));
    var r3 = (p3 == undefined) ? 1 : (p3.escape("x_pixels")) / (p3.escape("y_pixels"));
    var ratio = r1 + r2 + r3;
    return ({ p1: (r1/ratio),
              p2: (r2/ratio),
              p3: (r3/ratio) })
